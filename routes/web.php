...
Route::group(['middleware' => ['guest']], function(){  
    ...
    Route::view('/create-account', 'create_account'); 
...
Route::post('/api/create-account', 'RegisterController@createAccount');
...
Route::group(['middleware' => ['auth', 'admin']], function(){   
    Route::view('/admin/categories-post','admin.blog.category.index');
    Route::view('/admin/tags-post','admin.blog.tag.index');
    Route::view('/admin/posts','admin.blog.post.index');
